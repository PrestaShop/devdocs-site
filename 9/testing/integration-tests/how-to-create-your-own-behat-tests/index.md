...
url: "https://devdocs.prestashop-project.org/9/testing/integration-tests/how-to-create-your-own-behat-tests/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/testing/integration-tests/how-to-create-your-own-behat-tests.md"
---
...
{{% notice tip %}}
This tutorial guides you to create your first scenario step by step, if you need more details please read the [behat testing]({{< relref "/9/development/architecture/migration-guide/testing/behat.md" >}}) page.
{{% /notice %}}
