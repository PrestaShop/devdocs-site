...
url: "https://devdocs.prestashop-project.org/9/development/components/grid/tutorials/extend-grid-with-javascript/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/development/components/grid/tutorials/extend-grid-with-javascript.md"
---
...
(you can find more docs about grid in [The Grid component page]({{< ref "/9/development/components/grid/" >}}).
...
The last thing to do is to run the compiler. [More about compiler and npm commands here]({{< relref "/9/development/compile-assets" >}}).
