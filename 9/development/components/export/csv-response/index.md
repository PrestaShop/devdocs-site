...
url: "https://devdocs.prestashop-project.org/9/development/components/export/csv-response/"
version: "9"
description: "Learn how to use the CsvComponent to export data to CSV format"
source: "https://github.com/PrestaShop/docs/blob/9.x/development/components/export/csv-response.md"
---
