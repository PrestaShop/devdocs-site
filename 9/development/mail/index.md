...
url: "https://devdocs.prestashop-project.org/9/development/mail/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/development/mail.md"
---
...
{{% notice note %}}
The `Mail` core class extends [ObjectModel]({{< relref "/9/development/components/database/objectmodel" >}})
{{% /notice %}}
