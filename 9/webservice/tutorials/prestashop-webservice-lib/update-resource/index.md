...
url: "https://devdocs.prestashop-project.org/9/webservice/tutorials/prestashop-webservice-lib/update-resource/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/webservice/tutorials/prestashop-webservice-lib/update-resource.md"
---
...
{{% notice note %}}
You can update this schema using the [source XML file](/9/schemas/update-resource.xml) importable in services like [draw.io](https://draw.io).
{{% /notice %}}
