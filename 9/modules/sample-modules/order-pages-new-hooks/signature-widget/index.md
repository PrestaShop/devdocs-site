...
url: "https://devdocs.prestashop-project.org/9/modules/sample-modules/order-pages-new-hooks/signature-widget/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/modules/sample-modules/order-pages-new-hooks/signature-widget.md"
---
...
[Doctrine Object Relational Mapping (ORM) annotations]({{< relref "/9/modules/concepts/doctrine/#define-an-entity" >}}).
...
and [create services configuration]({{< relref "/9/modules/concepts/services/#symfony-services" >}}) for the above 
...
([read this article for more information]({{< relref "/9/modules/concepts/hooks#execution" >}})).
