...
url: "https://devdocs.prestashop-project.org/9/modules/sample-modules/order-pages-new-hooks/module-base/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/modules/sample-modules/order-pages-new-hooks/module-base.md"
---
...
functions because [Doctrine](https://symfony.com/doc/4.4/doctrine) is [not fully supported for modules installation]({{< relref "/9/modules/concepts/doctrine/#creating-the-database" >}}) at 1.7.7.0 release.
