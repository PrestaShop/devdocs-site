...
url: "https://devdocs.prestashop-project.org/9/modules/sample-modules/order-pages-new-hooks/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/modules/sample-modules/order-pages-new-hooks/_index.md"
---
...
While creating this component you will learn how to:
 ...
 - [Use Doctrine]({{< relref "/9/modules/concepts/doctrine/" >}})
 - [Use Repository classes extending Symfony EntityRepository](https://symfony.com/doc/4.4/doctrine/repository.html)
 - [Use Symfony services]({{< relref "/9/modules/concepts/services" >}})
 - [Use Twig templates to render HTML]({{< relref "/9/development/architecture/migration-guide/templating-with-twig" >}})
...
- To be familiar with [how Composer autoloads classes]({{< relref "/9/modules/concepts/composer" >}})
