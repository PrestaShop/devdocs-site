...
url: "https://devdocs.prestashop-project.org/9/scale/benchmark/front-office/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/scale/benchmark/front-office.md"
---
...
Follow instruction on **[Back-Office benchmark page]({{< relref "/9/scale/benchmark/back-office" >}})** to get a pre-populated shop and to run Gatling scenarios on it.
