...
url: "https://devdocs.prestashop-project.org/9/project/release/minor-release-lifecycle/"
version: "9"
source: "https://github.com/PrestaShop/docs/blob/9.x/project/release/minor-release-lifecycle.md"
---
...
If however you find a problem, you can
 ...
 - [Report this as a bug on GitHub](https://github.com/PrestaShop/PrestaShop/issues) (read [how to report issues]({{< relref "/9/contribute/contribute-reporting-issues" >}}))
 - Submit a bug fix by creating a [pull request](https://github.com/PrestaShop/PrestaShop/compare) (read the [contribution guidelines]({{< relref "/9/contribute/contribution-guidelines/" >}}))
